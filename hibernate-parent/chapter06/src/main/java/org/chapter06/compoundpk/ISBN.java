...
package org.chapter06.compoundpk;
...
public class ISBN implements Serializable {
   ...
   private static final long serialVersionUID = -5572570644342996170L;
   ...
   public boolean equals(Object o) {
      ...
      if (checkdigit != isbn.checkdigit)
         return false;
      if (group != isbn.group)
         return false;
      if (publisher != isbn.publisher)
         return false;
      if (title != isbn.title)
         return false;
